...
```bash
npx shadcn@latest add https://klarden-ui.com/r/portal-uploader.json
```
...
<PropsTable 
  data={[
    { name: "onUpload", type: "(file: File) => void", default: "—", description: "Callback triggered when a file is successfully dropped." },
    { name: "accept", type: "string", default: "—", description: 'Accepted file types (e.g., "image/*").' },
